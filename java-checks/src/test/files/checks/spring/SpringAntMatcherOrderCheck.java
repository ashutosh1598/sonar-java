  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http
      .authorizeRequests()
        ...
        .antMatchers("/secured/*/index", "/secured/socket", "/secured/success").authenticated() // Noncompliant [[sc=22;ec=40;secondary=46]] {{Reorder the URL patterns from most to less specific, the pattern "/secured/*/index" should occurs before "/secured/*/**".}}
    ...
    // coverage
    new AbstractRequestMatcherRegistry() {
      void init() {
        antMatchers("/home").permitAll()
          .antMatchers("/home").permitAll(); // false-negative, limitation
      }
    };
  }
